...
{: .notice--primary}
이번에 새로 안 점은, MultipartFile을 사용하기 위해서는 MultipartResolver 인터페이스를 Bean으로 등록해야 한다. <br>
...
```
사용자가 이미 등록된 사진을 교체할 경우의 분기 체크를 위해 MemberRepository도 같이 선언해서 사용했다. <br>
